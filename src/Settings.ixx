...
export const uint32_t CLUSTER_MANAGER_MANUAL_TOKEN_EXPIRY_SECONDS = CLUSTER_MANAGER_TOKEN_EXPIRY_SECONDS * 10;
export const uint32_t CLUSTER_MANAGER_MAX_TOKEN_EXPIRY_SECONDS    = CLUSTER_MANAGER_MANUAL_TOKEN_EXPIRY_SECONDS;
