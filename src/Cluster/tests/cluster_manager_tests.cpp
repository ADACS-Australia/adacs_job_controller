...
BOOST_AUTO_TEST_CASE(test_handleNewConnection_valid_uuid)
{
    ...
    BOOST_ASSERT_MSG(mgr->handleNewConnection(clusterConnection, last_uuid) != nullptr,
                     "handleNewConnection return nullptr which it should not have");
    ...
    BOOST_ASSERT_MSG(mgr->handleNewConnection(con, last_uuid) == nullptr,
                     "handleNewConnection did not return nullptr which it should have");
