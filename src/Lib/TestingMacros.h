...
#ifdef BUILD_TESTS
// NOLINTBEGIN
#define EXPOSE_PROPERTY_FOR_TESTING(term) \
public:                                   \
    auto get##term()                      \
    {                                     \
        return &term;                     \
    }                                     \
    auto set##term(typeof(term) value)    \
    {                                     \
        term = value;                     \
    }
#define EXPOSE_PROPERTY_FOR_TESTING_READONLY(term) \
public:                                            \
    auto get##term()                               \
    {                                              \
        return &term;                              \
    }
#define EXPOSE_FUNCTION_FOR_TESTING(term) \
public:                                   \
    auto call##term()                     \
    {                                     \
        return term();                    \
    }
#define EXPOSE_FUNCTION_FOR_TESTING_ONE_PARAM(term, param) \
public:                                                    \
    auto call##term(param value)                           \
    {                                                      \
        return term(value);                                \
    }
// NOLINTEND
