...
constexpr const char* ACCESS_SECRET_ENV_VARIABLE = "ACCESS_SECRET_CONFIG";
    ...
    constexpr const uint32_t QUEUE_SOURCE_PRUNE_MILLISECONDS = 60000;
    constexpr uint32_t CLUSTER_RESEND_MESSAGE_INTERVAL_MILLISECONDS = 60000;
    constexpr uint32_t CLIENT_TIMEOUT_SECONDS = 30;
#else
    ...
    constexpr uint32_t QUEUE_SOURCE_PRUNE_MILLISECONDS = 100;
    constexpr uint32_t CLUSTER_RESEND_MESSAGE_INTERVAL_MILLISECONDS = 100;
    constexpr uint32_t CLIENT_TIMEOUT_SECONDS = 1;
#endif
...
const uint32_t CLUSTER_MANAGER_PING_INTERVAL_SECONDS = 10;
const uint32_t CLUSTER_MANAGER_TOKEN_EXPIRY_SECONDS = 60;

const uint16_t HTTP_PORT = 8000;
const uint32_t HTTP_WORKER_POOL_SIZE = 1024;
const uint32_t HTTP_CONTENT_TIMEOUT_SECONDS = (60ULL*60ULL*24ULL);

const uint16_t WEBSOCKET_PORT = 8001;
const uint32_t WEBSOCKET_WORKER_POOL_SIZE = 1024;
